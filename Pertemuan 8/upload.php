...
// Mengelola unggahan file dari form_upload.php
if (isset($_POST["submit"])) {
    $targetDirectory = "C:/xampp/htdocs/dasarWeb/Pertemuan 8/"; //Direktori tujuan untuk menyimpan file
    ...
    if (isset($_FILES["documentToUpload"]) && in_array($documentFileType, $allowedExtensions) && $_FILES["documentToUpload"]["size"] <= $maxFileSize) {
