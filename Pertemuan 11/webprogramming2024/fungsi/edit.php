<?php
// Memperbarui data jabatan dalam database berdasarkan ID yang diterima melalui parameter POST
session_start();
if(!empty($_SESSION['username'])){
    ...
    // Memperbarui data anggota dalam database berdasarkan ID yang diterima melalui parameter POST
