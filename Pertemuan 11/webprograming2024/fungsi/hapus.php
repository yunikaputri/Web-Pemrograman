<?php
// Menghapus data jabatan dari database berdasarkan ID yang diterima melalui parameter GET
session_start();
if(!empty($_SESSION['username'])){
    ...
    // Menghapus data anggota dari database berdasarkan ID yang diterima melalui parameter GET
