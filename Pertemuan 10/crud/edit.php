...
<body>
    <?php
    // Mengedit data anggota dengan nilai-nilai awal yang diambil dari database
    include('koneksi.php');
    $id = $_GET['id'];
    ...
    <div class="container-mt4">
        ...
        <form action="proses.php?aksi=ubah" method="post">
            ...
            <div class="radio-group">
                ...
                echo 'checked'; ?> required><label for="laki">Laki-laki</label>
                <input type="radio" name="jenis_kelamin" value="P" id="perempuan" <?php if ($row['jenis_kelamin'] === 'P')
                echo 'checked'; ?> required><label for="perempuan">Perempuan</label>
            </div>
